...
<div class="container-fluid">
        <div class="panel panel-success" style="backgroud-color:#EFC8FB">
            <div class="panel-heading" align="center">
                	...
                	<h4><font align="left" color="black" style="font-family: Times New Roman; font-size:18px" >Your Project Bugs: "<s:property value="%{id}"/>"</font></h4>
              		...
              		<a href="BugEmp" class="btn btn-primary btn-md pull-left">BACK</a>
            </div>
            ...
            <div class="container">
   								...
   								<span class="close">×</span>
   								 <form action="update" >
             						...
             						<input type="hidden" name="post" id="post" class="form-control" value="null">
                              		  <label>Post your Solution</label> <textarea rows="4" cols="7"
                ...
                <div class="container " style="margin-top: 5%; margin-bottom:3%;">
                    ...
                    <div class="panel panel-danger" style="max-width: 80%;" align="left">
						...
						<form action="bug_insert" >
                            ...
                            <div class="form-group">
                                <label>POST</label> <textarea rows="6" cols="10"
